...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           # Get the filename and convert to lower case
           ...
           pet_label = name_part.replace('_', ' ')
           
           # Create pet_label by replacing numbers with empty string
           pet_label = ''.join([char for char in pet_label if not char.isdigit()])
